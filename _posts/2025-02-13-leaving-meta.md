...
(Maybe something about Meta is using your data to train its models.)
...
* If you (want to) allow Signal access to your contacts, you can see which of your contacts are already on the app.
...
## Other reasons to transition away from Meta and Big Tech

Still need to write this out. Is it even necesarry? 

Big tech 

Why move away from meta? filter bubbles, politics, politics, algorithmic future

Something about knowledge gap
