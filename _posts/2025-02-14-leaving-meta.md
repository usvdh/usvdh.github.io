...
However, starting your transition is easy! Install [Signal](https://signal.org/)! Signal is fully end-to-end encrypted, so no-one can see your texts, and they track absolutely 0 information about you. And there's even a desktop app!
...
My account address is "usvdh@kolektiva.social", try to find me :)
...
* Replace your web browser. For desktop, [Firefox](https://www.mozilla.org/en-US/firefox/new/) or [Orion](https://kagi.com/orion/) are very good alternatives. On your phone, the [DuckDuckGo](https://duckduckgo.com/app) browser is also a solid choice.
* Even if you have, say, Firefox as your browser, your internet searches will still be conducted with the Google search engine. Good alternatives for this are [DuckDuckGo](https://duckduckgo.com/) or [Startpage](https://www.startpage.com/). How to [change your search engine on Firefox](https://support.mozilla.org/en-US/kb/change-your-default-search-settings-firefox)
* Get [uBlock Origin](https://ublockorigin.com/) on your browser to block further tracking and targeted ads.
